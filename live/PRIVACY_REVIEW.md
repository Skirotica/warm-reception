...
**Sandbox bar before real send.** Private Live now shows the share of drafts approved without edit. Real mailbox send stays locked until that bar is at 75% on at least 8 Approve or Edit decisions, and until Chad opens the send step. GitHub Live does not show this scoreboard. No real mailbox is connected in this step.
