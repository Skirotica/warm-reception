...
**Email quality before real send.** Private Live now scores the emails the agent generated: share accepted as written (Approve, no Edit) versus rewritten (Edit). Real mailbox send stays locked until that quality bar is at 75% on at least 8 reviewed sequences, and until Chad opens the send step. GitHub Live does not show this scoreboard. No real mailbox is connected in this step.
