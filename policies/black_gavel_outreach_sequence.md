...
Business days only for tomorrow / two working days (skip Sat/Sun). Friday: Mon/Tue. Weekend: Mon/Tue. Thursday: Fri/Mon.
...
If you are building out key seats behind that move, we help growth-stage legaltech and fintech teams hire revenue and leadership talent without the usual noise.
